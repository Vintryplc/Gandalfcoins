...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1538163702;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 413744;
        ...
        vSeeds.push_back(CDNSSeedData("217.69.3.227", "217.69.3.227"));
        vSeeds.push_back(CDNSSeedData("108.61.123.200", "108.61.123.200"));
