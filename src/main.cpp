...
// Copyright (c) 2013 GadalfCoin developers
...
const string strMessageMagic = "GadalfCoin Signed Message:\n";
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GadalfCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GadalfCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("GadalfCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running GadalfCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GadalfCoinMiner terminated\n");
        throw;
    }
}
